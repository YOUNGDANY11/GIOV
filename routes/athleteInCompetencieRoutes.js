...
router.get('/name', auth, roleMiddleware(1,2,3,4), athleteInCompetencieController.getByNameAthlete)
router.get('/lastname', auth, roleMiddleware(1,2,3,4), athleteInCompetencieController.getByLastNameAthlete)
